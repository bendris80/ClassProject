...
QueryClause.prototype.SelectFirst = function (property, t) {
    return this._Select(property, 1);
}
...
Array.prototype.Filter = function (s) {
    ...
    var l = this.length, i, a = [], j, k = s.length, c;
    for (i = 0; i < l; i++) {
        v = this[i];
        c = true;
...
Array.prototype.Sort = function (property, sortorder, ignoreCase) {
    ...
    if (this[0][property] === undefined) return this;
    sortorder = sortorder === undefined ? SortOrder.Ascending : sortorder;
    if (property) {
        this.sort(function (a, b) {
            v1 = NinJa.EvalBind(property, a);
            v2 = NinJa.EvalBind(property, b);
        ...
        this.sort(function (a, b) {
            v1 = NinJa.EvalBind(property, a).toLowerCase();
            v2 = NinJa.EvalBind(property, b).toLowerCase();
...
Array.prototype.Minimum = function (array) {
